...
class GameProvider4by4 extends ChangeNotifier {
  ...
  void playGame(BuildContext context, {int? pos}) async {
    ...
    if (_playerTurn == null && !_hasCurrentGameSession && _currentGameUserChoice == null) {
      if (pos == null && _userChoice == 'O') {
        ...
        if(challengeType == 'E'){
          ...
          compPos = GeneratePlayGridFour().mediumMove(_gameplayList, _currentGameUserChoice == 'X' ? 0 : 1);
        }
